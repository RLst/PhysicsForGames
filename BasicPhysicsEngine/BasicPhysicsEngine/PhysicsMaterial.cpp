...
float PhysicsMaterial::getDensityFromMaterial(const eMaterial material)
{
	switch (material)
	{
	case eMaterial::HYDROGEN:		return 0.0898f;			break;
	case eMaterial::HELIUM:			return 0.179f;			break;
	case eMaterial::AEROGRAPHITE:	return 0.2f;			break;
	case eMaterial::AIR:			return 1.2f;			break;
	case eMaterial::TUNGSTEN_HEXAFLOURIDE: return 12.4f;	break;
	...
	case eMaterial::MERCURY:		return 13546;			break;
	...
	case eMaterial::OSMIUM:			return 22570;			break;
	default:						return -1;
	}
}
...
{
	//Custom density value will unset material (simplistic)
	m_material = eMaterial::NIL;
	m_density = density;
}
