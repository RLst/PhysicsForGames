...
struct ImGuiStyle
{
    ...
    float       WindowRounding;             // Radius of window vertices rounding. Set to 0.0f to have rectangular windows
    ImGuiAlign  WindowTitleAlign;           // Alignment for title bar text
    float       ChildWindowRounding;        // Radius of child window vertices rounding. Set to 0.0f to have rectangular windows
    ImVec2      FramePadding;               // Padding within a framed rectangle (used by most widgets)
    float       FrameRounding;              // Radius of frame vertices rounding. Set to 0.0f to have rectangular frame (used by most widgets).
    ...
    float       ScrollbarRounding;          // Radius of grab vertices for scrollbar
    float       GrabMinSize;                // Minimum width/height of a grab box for slider/scrollbar
    float       GrabRounding;               // Radius of grabs vertices rounding. Set to 0.0f to have rectangular slider grabs.
